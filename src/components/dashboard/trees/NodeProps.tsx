...
export const NodeProps = ({
    ...
    const ancestors = speciesList.filter(sp => !sp || (sp?.display && sp.id !== species?.id));
    return (<>
        <AuthField
            name="Species"
            selected={species?.id ?? ""}
        ...
        {species && <>
            ...
            <AuthField
                ...
                value={apparition === 0 ? "0" : nullableInput(apparition, a => (a / unit).toString())}
                ...
                setValue={updateProp(a => {
                    ...
                    apparition: species?.ancestor ? undefined : +a * unit,
                    afterApparition: species?.ancestor ? +a * unit - species.ancestor.apparition : undefined
                }))}
            >
